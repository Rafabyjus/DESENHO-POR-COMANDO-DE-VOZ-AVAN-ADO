...
recognition.onresult = function(event) {
 ...
 content = event.results[0][0].transcript;
    ...
    {
      document.getElementById("status").innerHTML = "o número nõ foi reconhecido.";
    }
...
function draw() {
  if(drawApple == "set")
  {
    for(var i = 1 ; i <= toNumber; i++) { x = Math.floor(Math.random() * 700); y = Math.floor(Math.random() * 400);
